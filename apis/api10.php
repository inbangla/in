...
$data = json_encode([
    'mobile' => '+' . $phone, // Add country code to the phone number
    'app_id' => '8329815A6D1AE6DD', // Replace with actual app ID
    'api_token' => '1NuLeEJojglISdJ8Ri8e8P50hxGPAYojba8PBT8FDWiKG30njAkhUbMkTUE1' // Replace with actual API token
]);
