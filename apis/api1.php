...
$data = [
    ...
    "Email" => "mdshahinislam@gmail.com", // Replace with actual email if needed
    "gender" => "on", // Gender information
    "FirstName" => "Md Shahin",
    "LastName" => "Islam",
    "DateOfBirthDay" => 20,
    "DateOfBirthMonth" => 12,
    ...
    "Newsletter" => "true",
    "Password" => "M2u2xcpin@6eCnj", // Example password
    "ConfirmPassword" => "M2u2xcpin@6eCnj", // Example password confirmation
    "__RequestVerificationToken" => "CfDJ8CrezBzBoNBPlgNiYsOS2zx24y35ebhPZHgEUlZwdYxKX0TKy5tGoy3Y6CGY2trwuWpNm-3RoiCARX1n3l_o5ts1G7K7D7k-j7yaO3fEvw8p0Msj76imD_Vah8XBPYsSGukBj4eRhPIpL_8aCUU9XAs" // This may need to be dynamic
];
...
// Initialize cURL
$url = 'https://www.othoba.com/register';
$ch = curl_init($url);
...
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    ...
    'Origin: https://www.othoba.com',
    'Referer: https://www.othoba.com/register',
